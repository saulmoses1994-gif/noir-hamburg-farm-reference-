...
export async function generateMetadata() {
  return buildMetadata({
    ...
    description: 'Handverlesene Begleitmodels von Noir Hamburg. Sorgfältig ausgewählte, diskrete und stilvolle Damen für Business, Dinner, Events und Reisen in Hamburg.',
    path: '/models',
    lang: 'de',
  })
}
...
export default async function ModelsList() {
  ...
  const jsonLd = [
    breadcrumbSchema([{ name: 'Home', url: '/' }, { name: 'Models', url: '/models' }]),
        ...
        <section className="px-6 md:px-12 lg:px-16 pt-8 md:pt-12 pb-8">
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <p className="mt-6 text-base sm:text-lg font-light text-[#6B5F5F] leading-relaxed">
              Handverlesene Begleitung für anspruchsvolle Kunden — vom ersten Kaffee bis zum stilvollen Dinner.
            </p>
          </div>
        </section>
