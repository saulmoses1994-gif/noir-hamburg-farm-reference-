...
export async function generateMetadata() {
  ...
  return buildMetadata({
    title: hub?.meta_title || t(lang, 'hub.metaTitle'),
    description: hub?.meta_description || t(lang, 'hub.metaDesc'),
    path: '/escort-hamburg',
    lang,
  })
}
...
export default async function EscortHamburgPage() {
  ...
  return <EscortHamburgBody lang="de" services={services} areas={areas} settings={settings} hub={hub} />
}
