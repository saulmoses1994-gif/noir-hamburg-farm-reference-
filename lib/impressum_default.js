// Default HTML content for the /impressum (§ 5 TMG) page. Rendered when
// site_settings.impressum_content is empty. Kept in a shared module so DE +
// EN routes stay in exact lockstep.
export const IMPRESSUM_DEFAULT_HTML = `
