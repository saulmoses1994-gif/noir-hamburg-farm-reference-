...
export default async function ContactBody({ lang, services = [], settings = {} }) {
  ...
  // SEO/link-quality: resolve the privacy-page URL so the sidebar link
  // lands directly on the 200-page (no 3xx hop). Returns /en/p/${slug}
  // when EN copy exists in the CMS, /p/${slug} otherwise. See
  // lib/pages.js `resolveContentPagePath`.
  const privacyHref = await resolveContentPagePath(lang, 'diskretion-und-datenschutz-noir-hamburg')
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12">
            ...
            <aside className="lg:col-span-4 lg:col-start-9 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-5 mt-4">
                  <a href={waHref} target="_blank" rel="noreferrer" className="flex items-center gap-4 group" data-testid="direct-whatsapp">
                    <span className="w-10 h-10 border border-[#1A1414]/15 group-hover:border-[#8B1538] flex items-center justify-center accent-text" aria-hidden="true">
              ...
              <div className="text-sm font-light text-[#6B5F5F] leading-relaxed">
                ...
                <Link href={privacyHref} className="underline decoration-[#8B1538]/40 hover:decoration-[#8B1538]">
